...
# # Create arrays of known face encodings and their names
# known_face_encodings = [amaan_face_encoding, neymar_face_encoding]
# known_face_names = ["Mohamed Amaan", "Neymar jr"]
...
#         flipped_left = frame.shape[1] - right
#         flipped_right = frame.shape[1] - left
...
#         # Draw a label with a name below the face
#         cv2.rectangle(
#             frame, (flipped_left, bottom - 35), (flipped_right, bottom), (0, 0, 255), cv2.FILLED
#         )
#         font = cv2.FONT_HERSHEY_DUPLEX
#         cv2.putText(frame, name, (flipped_left + 6, bottom - 6), font, 0.5, (255, 255, 255), 1)
